...
module.exports = function validateProfileInput(data){
  ...
  data.website = (data.company) ? data.company : '';
  ...
  if (!validator.isEmpty(data.youtube)) {
    if (!validator.isURL(data.youtube)) {
      errors.youtube = "website should valid URL."
    }
  }
  if (!validator.isEmpty(data.instagram)) {
    if (!validator.isURL(data.instagram)) {
      errors.instagram = "website should valid URL."
    }
  }
  if (!validator.isEmpty(data.twitter)) {
    if (!validator.isURL(data.twitter)) {
      errors.twitter = "website should valid URL."
    }
  }
  if (!validator.isEmpty(data.facebook)) {
    if (!validator.isURL(data.facebook)) {
      errors.facebook = "website should valid URL."
    }
  }
  return {
    errors,
