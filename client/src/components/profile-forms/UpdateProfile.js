...
const UpdateProfile = ({profile: {profile, loading}, createProfile,getCurrentUserProfile, history}) => {
...
export default connect(mapStateToProps, { createProfile, getCurrentUserProfile })(withRouter(UpdateProfile));